        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="p-12 bg-zinc-900/40 rounded-[3rem] border border-white/5 group hover:border-brand/30 transition-all">
              ...
              <h3 className="text-xl font-black uppercase tracking-tight mb-4 group-hover:text-brand transition-colors text-white">Encrypted Delivery</h3>
            ...
            <div className="p-12 bg-zinc-900/40 rounded-[3rem] border border-white/5 group hover:border-brand/30 transition-all">
              ...
              <h3 className="text-xl font-black uppercase tracking-tight mb-4 group-hover:text-brand transition-colors text-white">On-Site Safety</h3>
